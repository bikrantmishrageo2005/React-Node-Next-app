    ...
    >
      ...
      <div className="relative z-10">
        <div className="flex justify-between items-center mb-8">
          <h3 className="text-neon-cyan font-orbitron text-xl flex items-center gap-2">
            <Clock size={24} className="animate-spin-slow" /> FUTURE 2050 SIMULATION
          </h3>
          <div className="text-4xl font-bold font-orbitron text-white drop-shadow-[0_0_10px_rgba(0,243,255,0.8)]">
            {year}
          </div>
        </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
          <div className="text-center p-3 bg-white/5 rounded border border-white/10">
            <div className="text-xs text-gray-400 font-rajdhani mb-1">AQI LEVEL</div>
            <div className="text-xl font-bold text-neon-purple">{Math.round(currentData.aqi)}</div>
          </div>
          <div className="text-center p-3 bg-white/5 rounded border border-white/10">
            <div className="text-xs text-gray-400 font-rajdhani mb-1">HEAT RISE</div>
            <div className="text-xl font-bold text-neon-orange">+{currentData.heatRise}°C</div>
          </div>
          <div className="text-center p-3 bg-white/5 rounded border border-white/10">
            <div className="text-xs text-gray-400 font-rajdhani mb-1">FLOOD RISK</div>
            <div className="text-xl font-bold text-neon-blue">{currentData.floodRisk}%</div>
          </div>
          <div className="text-center p-3 bg-white/5 rounded border border-white/10">
            <div className="text-xs text-gray-400 font-rajdhani mb-1">SURVIVABILITY</div>
            <div className="text-xl font-bold text-neon-green">{currentData.survivabilityIndex}%</div>
          </div>
        </div>
        ...
        <div className="h-40 w-full">
           <ResponsiveContainer width="100%" height="100%">
             <LineChart data={data}>
               ...
               <XAxis dataKey="year" stroke="#666" tick={{fill: '#888', fontSize: 10}} />
        ...
        <div className="mt-6 text-center">
          <p className="text-neon-cyan font-orbitron text-sm animate-pulse">
            {year === 2050 
